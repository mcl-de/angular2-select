...
import * as import3 from './select.component';
...
import * as import20 from './select-dropdown.component';
import * as import21 from './select-dropdown.component.ngfactory';
import * as import22 from './diacritics.service';
...
class _View_SelectComponent_Host0 extends import1.AppView<any> {
  ...
  get _NG_VALUE_ACCESSOR_0_5():any[] {
    if ((this.__NG_VALUE_ACCESSOR_0_5 == (null as any))) { (this.__NG_VALUE_ACCESSOR_0_5 = [this._SelectComponent_0_4]); }
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._SelectComponent_0_4 = new import3.SelectComponent();
...
function viewFactory_SelectComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_SelectComponent_Host === (null as any))) { (renderType_SelectComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
...
class _View_SelectComponent0 extends import1.AppView<import3.SelectComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_1,'style','width:100%;position:relative;');
    ...
    this._NgClass_3_3 = new import12.NgClass(this.parentInjector.get(import14.IterableDiffers),this.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_3),this.renderer);
    this._text_4 = this.renderer.createText(this._el_3,'\n        ',(null as any));
    this._el_5 = this.renderer.createElement(this._el_3,'span',(null as any));
    this.renderer.setElementAttribute(this._el_5,'class','selection');
    ...
    this._NgClass_7_3 = new import12.NgClass(this.parentInjector.get(import14.IterableDiffers),this.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_7),this.renderer);
    ...
    this._el_15 = this.renderer.createElement(this._el_7,'span',(null as any));
    this.renderer.setElementAttribute(this._el_15,'class','select2-selection__arrow');
    ...
    this._appEl_23 = new import2.AppElement(23,1,this,this._anchor_23);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import12.NgClass) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._NgClass_7_3; }
    if (((token === import12.NgClass) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._NgClass_3_3; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = this.context.getContainerClass();
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._NgClass_3_3.ngClass = currVal_2;
      this._expr_2 = currVal_2;
    }
    if (!throwOnChange) { this._NgClass_3_3.ngDoCheck(); }
    const currVal_5:any = this.context.getSelectionClass();
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._NgClass_7_3.ngClass = currVal_5;
      this._expr_5 = currVal_5;
    }
    if (!throwOnChange) { this._NgClass_7_3.ngDoCheck(); }
    const currVal_6:boolean = !this.context.multiple;
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._NgIf_9_6.ngIf = currVal_6;
      this._expr_6 = currVal_6;
    }
    const currVal_7:boolean = (!this.context.multiple && (this.context.selection.length > 0));
    if (import4.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this._NgIf_11_6.ngIf = currVal_7;
      this._expr_7 = currVal_7;
    }
    const currVal_8:any = this.context.multiple;
    if (import4.checkBinding(throwOnChange,this._expr_8,currVal_8)) {
      this._NgIf_13_6.ngIf = currVal_8;
      this._expr_8 = currVal_8;
    }
    const currVal_9:any = this.context.isOpen;
    ...
    if (!throwOnChange) {
      if (this._viewQuery_dropdown_2.dirty) {
          this._viewQuery_dropdown_2.reset([this._appEl_23.mapNestedViews(_View_SelectComponent6,(nestedView:_View_SelectComponent6):any => {
            return [nestedView._SelectDropdownComponent_0_4];
        })]);
  ...
  private _handle_resize_3_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.onWindowResize()) !== false);
    return (true && pd_0);
  }
  private _handle_click_3_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onWindowClick()) !== false);
    return (true && pd_0);
  }
  private _handle_click_7_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onSelectionClick($event)) !== false);
    return (true && pd_0);
  }
...
export function viewFactory_SelectComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SelectComponent> {
  if ((renderType_SelectComponent === (null as any))) { (renderType_SelectComponent = viewUtils.createRenderComponentType('/home/mfkinder/Desktop/angular2-select/src/select.component.ts class SelectComponent - inline template',0,import9.ViewEncapsulation.Emulated,styles_SelectComponent,{})); }
...
class _View_SelectComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_0,'class','select2-selection__rendered');
    this._text_1 = this.renderer.createText(this._el_0,'\n                    ',(null as any));
    this._el_2 = this.renderer.createElement(this._el_0,'span',(null as any));
    this.renderer.setElementAttribute(this._el_2,'class','select2-selection__placeholder');
...
class _View_SelectComponent2 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this.parent.context.allowClear;
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
...
class _View_SelectComponent3 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'span',(null as any));
    this.renderer.setElementAttribute(this._el_0,'class','select2-selection__clear');
    this._text_1 = this.renderer.createText(this._el_0,'\n                        x\n                    ',(null as any));
...
class _View_SelectComponent4 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._NgFor_2_6 = new import18.NgFor(this._appEl_2.vcRef,this._TemplateRef_2_5,this.parent.parentInjector.get(import14.IterableDiffers),this.parent.ref);
    this._text_3 = this.renderer.createText(this._el_0,'\n                    ',(null as any));
    this._el_4 = this.renderer.createElement(this._el_0,'li',(null as any));
    this.renderer.setElementAttribute(this._el_4,'class','select2-search select2-search--inline');
    this._text_5 = this.renderer.createText(this._el_4,'\n                        ',(null as any));
    this._el_6 = this.renderer.createElement(this._el_4,'input',(null as any));
    this.renderer.setElementAttribute(this._el_6,'class','select2-search__field');
    this._NgStyle_6_3 = new import19.NgStyle(this.parent.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_6),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.NgStyle) && (6 === requestNodeIndex))) { return this._NgStyle_6_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    var changes:{[key: string]:import7.SimpleChange} = (null as any);
    changes = (null as any);
    const currVal_0:any = this.parent.context.selection;
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
    ...
    const currVal_4:any = this.parent.context.getInputStyle();
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._NgStyle_6_3.ngStyle = currVal_4;
      this._expr_4 = currVal_4;
    }
    if (!throwOnChange) { this._NgStyle_6_3.ngDoCheck(); }
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_3:any = import4.interpolate(1,'',this.parent.context.getPlaceholder(),'');
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setElementProperty(this._el_6,'placeholder',currVal_3);
  ...
  private _handle_keydown_6_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.onSearchKeydown($event)) !== false);
    return (true && pd_0);
  }
}
...
class _View_SelectComponent5 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_0,'class','select2-selection__choice');
    this._text_1 = this.renderer.createText(this._el_0,'\n                        ',(null as any));
    this._el_2 = this.renderer.createElement(this._el_0,'span',(null as any));
    this.renderer.setElementAttribute(this._el_2,'class','select2-selection__choice__remove');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import4.interpolate(1,'',this.context.$implicit.label,'');
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setElementAttribute(this._el_2,'data-value',((currVal_2 == (null as any))? (null as any): currVal_2.toString()));
      this._expr_2 = currVal_2;
    }
  ...
  private _handle_click_2_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.parent.context.onClearItemClick($event)) !== false);
    return (true && pd_0);
  }
}
...
class _View_SelectComponent6 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _SelectDropdownComponent_0_4:import20.SelectDropdownComponent;
  _text_1:any;
  /*private*/ _expr_2:any;
  /*private*/ _expr_3:any;
  /*private*/ _expr_4:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'select-dropdown',(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = import21.viewFactory_SelectDropdownComponent0(this.viewUtils,this.injector(0),this._appEl_0);
    this._SelectDropdownComponent_0_4 = new import20.SelectDropdownComponent(this.parent.parentInjector.get(import22.DiacriticsService));
    this._appEl_0.initComponent(this._SelectDropdownComponent_0_4,[],compView_0);
    this._text_1 = this.renderer.createText((null as any),'\n    ',(null as any));
    compView_0.create(this._SelectDropdownComponent_0_4,[],(null as any));
    ...
    this._expr_7 = import7.UNINITIALIZED;
    this._expr_8 = import7.UNINITIALIZED;
    const subscription_0:any = this._SelectDropdownComponent_0_4.close.subscribe(this.eventHandler(this._handle_close_0_1.bind(this)));
    const subscription_1:any = this._SelectDropdownComponent_0_4.toggleSelect.subscribe(this.eventHandler(this._handle_toggleSelect_0_0.bind(this)));
    this.init([].concat([this._el_0]),[
      this._el_0,
      this._text_1
    ]
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import20.SelectDropdownComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._SelectDropdownComponent_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    var changes:{[key: string]:import7.SimpleChange} = (null as any);
    changes = (null as any);
    const currVal_2:any = this.parent.context.multiple;
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._SelectDropdownComponent_0_4.multiple = currVal_2;
      if ((changes === (null as any))) { (changes = {}); }
      changes['multiple'] = new import7.SimpleChange(this._expr_2,currVal_2);
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = this.parent.context.optionValues;
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this._SelectDropdownComponent_0_4.optionValues = currVal_3;
      if ((changes === (null as any))) { (changes = {}); }
      changes['optionValues'] = new import7.SimpleChange(this._expr_3,currVal_3);
      this._expr_3 = currVal_3;
    }
    const currVal_4:any = this.parent.context.optionsDict;
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._SelectDropdownComponent_0_4.optionsDict = currVal_4;
      if ((changes === (null as any))) { (changes = {}); }
      changes['optionsDict'] = new import7.SimpleChange(this._expr_4,currVal_4);
      this._expr_4 = currVal_4;
    }
    const currVal_5:any = this.parent.context.selection;
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._SelectDropdownComponent_0_4.selection = currVal_5;
      if ((changes === (null as any))) { (changes = {}); }
      changes['selection'] = new import7.SimpleChange(this._expr_5,currVal_5);
      this._expr_5 = currVal_5;
    }
    const currVal_6:any = this.parent.context.width;
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._SelectDropdownComponent_0_4.width = currVal_6;
      if ((changes === (null as any))) { (changes = {}); }
      changes['width'] = new import7.SimpleChange(this._expr_6,currVal_6);
      this._expr_6 = currVal_6;
    }
    const currVal_7:any = this.parent.context.top;
    if (import4.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this._SelectDropdownComponent_0_4.top = currVal_7;
      if ((changes === (null as any))) { (changes = {}); }
      changes['top'] = new import7.SimpleChange(this._expr_7,currVal_7);
      this._expr_7 = currVal_7;
    }
    const currVal_8:any = this.parent.context.left;
    if (import4.checkBinding(throwOnChange,this._expr_8,currVal_8)) {
      this._SelectDropdownComponent_0_4.left = currVal_8;
      if ((changes === (null as any))) { (changes = {}); }
      changes['left'] = new import7.SimpleChange(this._expr_8,currVal_8);
      this._expr_8 = currVal_8;
    }
    if ((changes !== (null as any))) { this._SelectDropdownComponent_0_4.ngOnChanges(changes); }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._SelectDropdownComponent_0_4.ngOnInit(); }
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._SelectDropdownComponent_0_4.ngAfterViewInit(); } }
  }
  dirtyParentQueriesInternal():void {
  ...
  private _handle_toggleSelect_0_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.onToggleSelect($event)) !== false);
    return (true && pd_0);
  }
  private _handle_close_0_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.onClose($event)) !== false);
    return (true && pd_0);
  }
}
