...
import * as import3 from './select-dropdown.component';
...
var renderType_SelectDropdownComponent_Host:import0.RenderComponentType = (null as any);
class _View_SelectDropdownComponent_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _SelectDropdownComponent_0_4:import3.SelectDropdownComponent;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SelectDropdownComponent_Host0,renderType_SelectDropdownComponent_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('select-dropdown',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_SelectDropdownComponent0(this.viewUtils,this.injector(0),this._appEl_0);
    this._SelectDropdownComponent_0_4 = new import3.SelectDropdownComponent(this.parentInjector.get(import8.DiacriticsService));
    this._appEl_0.initComponent(this._SelectDropdownComponent_0_4,[],compView_0);
    compView_0.create(this._SelectDropdownComponent_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.SelectDropdownComponent) && (0 === requestNodeIndex))) { return this._SelectDropdownComponent_0_4; }
...
function viewFactory_SelectDropdownComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_SelectDropdownComponent_Host === (null as any))) { (renderType_SelectDropdownComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
...
class _View_SelectDropdownComponent0 extends import1.AppView<import3.SelectDropdownComponent> {
  _viewQuery_input_0:import11.QueryList<any>;
  _viewQuery_optionsList_1:import11.QueryList<any>;
  _text_0:any;
  _el_1:any;
  _NgStyle_1_3:import12.NgStyle;
  _text_2:any;
  _el_3:any;
  _NgStyle_3_3:import12.NgStyle;
  _text_4:any;
  _anchor_5:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SelectDropdownComponent0,renderType_SelectDropdownComponent,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_1,'class','select2-container select2-container--default select2-container--open');
    this._NgStyle_1_3 = new import12.NgStyle(this.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_1),this.renderer);
    this._text_2 = this.renderer.createText(this._el_1,'\n    ',(null as any));
    this._el_3 = this.renderer.createElement(this._el_1,'span',(null as any));
    this.renderer.setElementAttribute(this._el_3,'class','select2-dropdown select2-dropdown--below');
    this._NgStyle_3_3 = new import12.NgStyle(this.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_3),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_7,'class','select2-results');
    this._text_8 = this.renderer.createText(this._el_7,'\n            ',(null as any));
    this._el_9 = this.renderer.createElement(this._el_7,'ul',(null as any));
    this.renderer.setElementAttribute(this._el_9,'class','select2-results__options');
    ...
    this._NgFor_11_6 = new import14.NgFor(this._appEl_11.vcRef,this._TemplateRef_11_5,this.parentInjector.get(import18.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.NgFor) && (11 === requestNodeIndex))) { return this._NgFor_11_6; }
    ...
    if (((token === import12.NgStyle) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._NgStyle_3_3; }
    if (((token === import12.NgStyle) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._NgStyle_1_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    var changes:{[key: string]:import7.SimpleChange} = (null as any);
    const currVal_0:any = this._map_0('absolute',(this.context.top + 'px'),(this.context.left + 'px'));
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this._NgStyle_1_3.ngStyle = currVal_0;
      this._expr_0 = currVal_0;
    }
    if (!throwOnChange) { this._NgStyle_1_3.ngDoCheck(); }
    const currVal_1:any = this._map_1((this.context.width + 'px'));
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this._NgStyle_3_3.ngStyle = currVal_1;
      this._expr_1 = currVal_1;
    }
    if (!throwOnChange) { this._NgStyle_3_3.ngDoCheck(); }
    const currVal_2:boolean = !this.context.multiple;
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._NgIf_5_6.ngIf = currVal_2;
      this._expr_2 = currVal_2;
    }
    changes = (null as any);
    const currVal_6:any = this.context.optionValuesFiltered;
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._NgFor_11_6.ngForOf = currVal_6;
    ...
    const currVal_7:any = (this.context.optionValuesFiltered.length === 0);
  ...
  private _handle_mousemove_9_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.onOptionsMouseMove($event)) !== false);
    return (true && pd_0);
  }
  private _handle_wheel_9_1($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onOptionsWheel($event)) !== false);
    return (true && pd_0);
  }
  private _handle_click_9_2($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.onOptionsClick($event)) !== false);
    return (true && pd_0);
  }
}
export function viewFactory_SelectDropdownComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.SelectDropdownComponent> {
  if ((renderType_SelectDropdownComponent === (null as any))) { (renderType_SelectDropdownComponent = viewUtils.createRenderComponentType('/home/mfkinder/Desktop/angular2-select/src/select-dropdown.component.ts class SelectDropdownComponent - inline template',0,import9.ViewEncapsulation.Emulated,styles_SelectDropdownComponent,{})); }
  return new _View_SelectDropdownComponent0(viewUtils,parentInjector,declarationEl);
}
class _View_SelectDropdownComponent1 extends import1.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SelectDropdownComponent1,renderType_SelectDropdownComponent,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'span',(null as any));
    this.renderer.setElementAttribute(this._el_0,'class','select2-search select2-search--dropdown');
    this._text_1 = this.renderer.createText(this._el_0,'\n            ',(null as any));
    this._el_2 = this.renderer.createElement(this._el_0,'input',(null as any));
    this.renderer.setElementAttribute(this._el_2,'class','select2-search__field');
  ...
  private _handle_click_2_2($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.parent.context.onInputClick($event)) !== false);
    return (true && pd_0);
  }
}
function viewFactory_SelectDropdownComponent1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  return new _View_SelectDropdownComponent1(viewUtils,parentInjector,declarationEl);
}
class _View_SelectDropdownComponent2 extends import1.AppView<any> {
  _el_0:any;
  ...
  /*private*/ _expr_4:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SelectDropdownComponent2,renderType_SelectDropdownComponent,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'li',(null as any));
    this._NgClass_0_3 = new import19.NgClass(this.parent.parentInjector.get(import18.IterableDiffers),this.parent.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_0),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import19.NgClass) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._NgClass_0_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_3:any = this.parent.context.getOptionClass(this.context.$implicit);
    ...
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = this.parent.context.optionsDict[this.context.$implicit].selected;
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementAttribute(this._el_0,'aria-selected',((currVal_0 == (null as any))? (null as any): currVal_0.toString()));
      this._expr_0 = currVal_0;
    }
    const currVal_1:any = this.parent.context.optionsDict[this.context.$implicit].disabled;
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementAttribute(this._el_0,'aria-disabled',((currVal_1 == (null as any))? (null as any): currVal_1.toString()));
      this._expr_1 = currVal_1;
    }
...
function viewFactory_SelectDropdownComponent2(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  return new _View_SelectDropdownComponent2(viewUtils,parentInjector,declarationEl);
}
class _View_SelectDropdownComponent3 extends import1.AppView<any> {
  _el_0:any;
  _NgClass_0_3:import19.NgClass;
  _text_1:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_SelectDropdownComponent3,renderType_SelectDropdownComponent,import6.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.renderer.createElement((null as any),'li',(null as any));
    this._NgClass_0_3 = new import19.NgClass(this.parent.parentInjector.get(import18.IterableDiffers),this.parent.parentInjector.get(import15.KeyValueDiffers),new import16.ElementRef(this._el_0),this.renderer);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this.parent.context.getOptionClass((null as any));
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
...
function viewFactory_SelectDropdownComponent3(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
